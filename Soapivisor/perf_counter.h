...
///
/// @warning
/// All exposed interfaces but #Soapivisor_PERFCOUNTER_MEASURE_TIME are meant
...
#define Soapivisor_PERFCOUNTER_P_JOIN2(x, y) x##y
#define Soapivisor_PERFCOUNTER_P_JOIN1(x, y) \
  Soapivisor_PERFCOUNTER_P_JOIN2(x, y)

/// Concatenates two tokens
/// @param x  1st token
/// @param y  2nd token
#define Soapivisor_PERFCOUNTER_P_JOIN(x, y) \
  Soapivisor_PERFCOUNTER_P_JOIN1(x, y)

#define Soapivisor_PERFCOUNTER_P_TO_STRING1(n) #n

/// Converts a token to a string literal
/// @param n  A token to convert to a string literal
#define Soapivisor_PERFCOUNTER_P_TO_STRING(n) \
  Soapivisor_PERFCOUNTER_P_TO_STRING1(n)
...
/// @see Soapivisor_PERFCOUNTER_MEASURE_TIME
///
/// This macro should not be used directly. Instead use
/// #Soapivisor_PERFCOUNTER_MEASURE_TIME.
///
...
/// @code{.cpp}
/// Hello.cpp:233 | {
/// Hello.cpp:234 |   Soapivisor_PERFCOUNTER_MEASURE_TIME(collector, fn);
...
#define Soapivisor_PERFCOUNTER_MEASURE_TIME(collector, query_time_routine) \
  const PerfCounter Soapivisor_PERFCOUNTER_P_JOIN(perf_obj_, __COUNTER__)( \
      (collector), (query_time_routine),                                      \
      __FUNCTION__ "(" Soapivisor_PERFCOUNTER_P_TO_STRING(__LINE__) ")")
...
class PerfCounter {
 public:
  ...
  ///
  /// #Soapivisor_PERFCOUNTER_MEASURE_TIME() should be used to create an
...
#endif  // Soapivisor_PERF_COUNTER_H_
