...
#ifndef Soapivisor_PERFORMANCE_H_
#define Soapivisor_PERFORMANCE_H_
...
#if (Soapivisor_PERFORMANCE_ENABLE_PERFCOUNTER != 0)
...
/// #Soapivisor_PERFCOUNTER_MEASURE_TIME() for details.
#define Soapivisor_PERFORMANCE_MEASURE_THIS_SCOPE() \
  Soapivisor_PERFCOUNTER_MEASURE_TIME(g_performance_collector, PerfGetTime)
...
/// Makes #Soapivisor_PERFORMANCE_MEASURE_THIS_SCOPE() ready for use
...
///
/// It should only be used by #Soapivisor_PERFORMANCE_MEASURE_THIS_SCOPE().
ULONG64 PerfGetTime();
...
#endif  // Soapivisor_PERFORMANCE_H_
